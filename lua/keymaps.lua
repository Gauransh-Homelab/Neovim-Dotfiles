...
-- Arrow key navigation in insert mode only
...
local function harpoon_action(action)
  return function()
...
vim.keymap.set('n', '<leader>ha', harpoon_action(function(harpoon)
  harpoon:list():add()
end), { desc = 'Harpoon [a]dd file' })
vim.keymap.set('n', '<leader>hh', harpoon_action(function(harpoon)
  harpoon.ui:toggle_quick_menu(harpoon:list())
end), { desc = 'Harpoon toggle menu' })
vim.keymap.set('n', '<leader>h1', harpoon_action(function(harpoon)
  harpoon:list():select(1)
end), { desc = 'Harpoon file 1' })
vim.keymap.set('n', '<leader>h2', harpoon_action(function(harpoon)
  harpoon:list():select(2)
end), { desc = 'Harpoon file 2' })
vim.keymap.set('n', '<leader>h3', harpoon_action(function(harpoon)
  harpoon:list():select(3)
end), { desc = 'Harpoon file 3' })
vim.keymap.set('n', '<leader>h4', harpoon_action(function(harpoon)
  harpoon:list():select(4)
end), { desc = 'Harpoon file 4' })
vim.keymap.set('n', '<leader>hp', harpoon_action(function(harpoon)
  harpoon:list():prev()
end), { desc = 'Harpoon [p]revious' })
vim.keymap.set('n', '<leader>hn', harpoon_action(function(harpoon)
  harpoon:list():next()
